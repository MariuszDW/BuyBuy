...
final class TestMockDataManager: DataManagerProtocol, @unchecked Sendable {
    ...
    var persistentStoreChangeObserver: any BuyBuy.PersistentStoreChangeObserverProtocol = MockPersistentStoreChangeObserver()
    ...
    func fetchShoppingItemsOfList(with id: UUID) async throws -> [BuyBuy.ShoppingItem] {
        return []
    }
